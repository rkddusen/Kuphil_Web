    ...
    if(num > 5){
        ...
        switch(num){
            case 5: 
                ...
                buildTwo += '<div class="poster_img" id = "poster_2">' + '<img onclick = "openModal('+2+')" class="thumbnail_1" src="./image/poster/poster_2.jpg" alt="정보가 없습니다." .>' + '<div class="poster_title">제2회</div></div>';
                buildTwo += '<div class="poster_img" id = "poster_1">' + '<img onclick = "openModal('+1+')" class="thumbnail_1" src="./image/poster/poster_1.jpg" alt="정보가 없습니다." .>' + '<div class="poster_title">제1회</div></div>';
                break;
            case 4:
                for (i=0; i<3; i++){
                buildOne += '<div class="poster_img" id = "poster_' + (num-i) + '">' + '<img onclick = "openModal('+(num-i)+')" class="thumbnail_1" src="./image/poster/poster_'  + (num-i) + '.jpg" alt="정보가 없습니다." .>' + '<div class="poster_title"">제' + (num-i) + '회</div></div>';
                }
            ...
            case 3:
                ...
                break;
            case 2: 
                buildOne += '<div class="poster_img" id = "poster_2">' + '<img onclick = "openModal('+2+')" class="thumbnail_1" src="./image/poster/poster_2.jpg" alt="정보가 없습니다." .>' + '<div class="poster_title">제2회</div></div>';
                buildOne += '<div class="poster_img" id = "poster_1">' + '<img onclick = "openModal('+1+')" class="thumbnail_1" src="./image/poster/poster_1.jpg" alt="정보가 없습니다." .>' + '<div class="poster_title">제1회</div></div>';
                break;
            case 1:
                buildOne += '<div class="poster_img" id = "poster_1">' + '<img onclick = "openModal('+1+')" class="thumbnail_1" src="./image/poster/poster_1.jpg" alt="정보가 없습니다." .>' + '<div class="poster_title">제1회</div></div>';
                break;
